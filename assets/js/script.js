...
var formSubmitHandler = function(event) {
    ...
    if (cityName) {
        ...
        alert("Please enter a vailid city");
    }
...
var displayForecast = function(cities, nameOfCity) {     
    ...
    if (cities.length === 0) {
        currentForecastEl.textContent = " Unable to find that location";
        return;
    };
...
var getCurrentCoord = function(city) {
    var apiUrl = "https://api.openweathermap.org"+ city + "5a8f341fcd560b99db6192746e3364a5";
